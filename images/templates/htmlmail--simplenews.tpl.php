...
$template_url = url($template_path, ['absolute' => TRUE]);
dsm('hey');
print "hey";
?>
<?php if ($key == 'node' || $key == 'test'): ?>
    <div class="htmlmail-simplenews-link">
        <a href="<?php echo url('node/' . $params['simplenews_source']->getNode()->nid, ['absolute' => TRUE]); ?>">
            ...
            <dd>
                <ol>
                    <li><p><?php if (empty($theme)): ?>
                            ...
                            and select a theme to hold your custom email
                            template files.
                        </p></li>
                    ...
                    <li><?php
                      ...
                      if (!file_exists("$theme_path/$module_template")): ?><p>
                            For general Simplenews message customization,
                            copy<br/>
                            <u><code><?php echo "$module_path/htmlmail.tpl.php"; ?></code></u>
                            <br/>to<br/>
                    ...
                    <li><?php
                            ...
                            Send a test message to make sure your customizations
                            worked.
                        </p></li>
                    <li><p>
                            If you think your customizations would be of use to
                            others,
                            please contribute your file as a feature request in
                            the
                            <a href="http://drupal.org/node/add/project-issue/htmlmail">issue
                                queue</a>.
                        </p></li>
                </ol>
            </dd>
            <dt><p>
                    The simplenews module sets the <u><code>$params</code></u>
                    variable.
                    For this message,
                </p></dt>
            <dd>
