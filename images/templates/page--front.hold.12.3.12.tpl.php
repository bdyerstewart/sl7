      ...
      $div_id++; ?> headwrap"
          ...
          <div class="ss-caption"
            ...
            if ($banner->body) {
              ...
              print "<p>" . $text . "<a class='more' href='" . $b_url . "' >  More...</a></p>";
            }
            ?>
          </div>
      </div>
...
<script type="text/javascript">
  ...
  window.setTimeout(function () {
    jQuery("body.front .browse-topics a").removeClass("hover");
    jQuery("body.front .browse-topics ul").css('visibility', 'hidden');
  }, 2500);
</script>
