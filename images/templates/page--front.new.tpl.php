    ...
    <div id="header">
      ...
      <?php endif; ?>
        ...
        <ul id="top-nav">
            ...
            <li> |</li>
            <li><a id="feedback"
                   href="<?php print $base_url; ?>how-can-we-serve-you-better">+
                    feedback</a></li>
        </ul><!-- end top-nav -->
    </div><!-- end header -->
    <div id="nav-wrapper">
            ...
            <div class="slides_container">
              <?php foreach ($banners as $banner) : ?>
                <?php $img = $base_path . "sites/default/files/" . $banner->filename; ?>
                  <div class="slide"
                       style="background-image:url(<?php print $img; ?>)"></div>
              <?php endforeach; ?>
            </div>
        </div>
    </div>
    ...
    <div id="content">
        ...
        <div class="m-col" id="featured">
            <div class="post-header">
                <h3 class="title">Featured <a href="#" class="more">View All</a>
                </h3>
            </div><!-- end post-header -->
        ...
        <div class="r-col">
            <div class="post-header">
                <h3 class="title">News &amp; Media <a href="militarynews"
                                                      class="more">View All</a>
                </h3>
            </div><!-- end post-header -->
...
<div id="footer-wrapper">
    <div id="footer">
        <div id="f-left">
            <div id="copyright">
                <p> &copy; <strong> Stateside Legal </strong> All rights
                    reserved.</p>
                <p><a href="#"> Terms of Use </a> <a href="#"> Privacy
                        Policy </a></p>
            </div><!-- end copyright -->
            <a href="<?php print $base_path; ?>how-can-we-serve-you-better"
               class="red-button"> + Feedback </a>
            <div id="footer-logos">
                <img src="./<?php print drupal_get_path('theme', 'state7'); ?>/images/joiningforces.gif"
                     alt="" title="">
                <img src="./<?php print drupal_get_path('theme', 'state7'); ?>/images/lsc.gif"
                     alt="" title="">
                ...
                <ul>
                    <li>
                        ...
                        <ul>
                            ...
                            <li class="list-col-1-1"><a href="#">Social
                                    Security</a></li>
                            <li class="list-col-1-1"><a href="#">Public
                                    Benefits</a></li>
                            <li class="list-col-1-1"><a href="#">Immigration</a>
                            </li>
                            <li class="list-col-1-1"><a href="#">Housing</a>
                            </li>
                            <li class="list-col-1-1"><a href="#">Health</a></li>
                            <li class="list-col-1-1"><a href="#">Family Law</a>
                            </li>
                            <li class="list-col-1-2"><a href="#">Estate
                                    Planning</a></li>
                            <li class="list-col-1-2"><a href="#">Employement</a>
                            </li>
                            <li class="list-col-1-2"><a href="#">Education</a>
                            </li>
                            <li class="list-col-1-2"><a href="#">Consumer</a>
                            </li>
                            <li class="list-col-1-2"><a href="#">Civil
                                    Rights</a></li>
