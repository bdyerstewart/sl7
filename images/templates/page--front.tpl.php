...
$mtag = metatag_metatags_view('global:frontpage', []);
render($mtag);
?>
<div id="header-wrapper">
        ...
        <div id="social">
            ...
            <div class="addthis_toolbox addthis_32x32_style addthis_default_style">
                <a href="http://statesidelegal.org/rss.xml">
                    <img width="32" height="32" title="Subscribe to RSS"
        ...
        <ul id="top-nav">
          <?php if ($logged_in) : ?>
            ...
            <?php endif; ?>
              <li> |</li>
              <li>
                  <a href="<?php print $base_path; ?>user/<?php print $user->uid; ?>">my
                      account</a></li>
          <?php else : ?>
          ...
          <?php if (user_has_role(11)) : ?>
              <li> |</li>
              <li><a href="<?php print $base_path . 'my-groups'; ?>">my
                      groups</a></li>
          <?php endif; ?>
            <li> |</li>
    ...
    <div id="nav-wrapper">
        <a class="nav-toggle"
           href="#"><?php print "<i class='fa fa-bars'></i> " . t("Menu"); ?></a>
      <?php if ($main_menu) {
        print $menu_out;
      } ?>
    </div><!-- end nav-wrapper -->
  ...
  <?php foreach ($banners as $banner) : ?>
    <?php $img = $base_path . "sites/default/files/" . $banner->filename; ?>
      <div class="headwrap<?php print $div_id;
      $div_id++; ?> headwrap"
           style="background-image:url(<?php print $img; ?>)">
          <div class="ss-caption"
               onclick="window.location.href = '<?php print "node/" . $banner->nid; ?>'">
            <?php
...
<script type="text/javascript">
  ...
  jQuery('#bannerframe').cycle({
    fx: 'fade', prev: '#prev', next: '#next', pause: true, before: slideAction
  });
