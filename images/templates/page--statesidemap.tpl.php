...
<div id="statesidepopup">
    ...
    <div id="contactArea">
        ...
        <p>Free legal help for all people with <a
                    href="http://www.statesidelegal.org/federal-poverty-level-guidelines">low
                incomes</a><br/>
            Specialities: housing, family, consumer and public benefits.
            Referrals for help
            with other kinds of legal problems.</p>
        <h6>State Veterans Affairs Offices</h6>
        <p>Free non-lawyer advocates for veterans. Specialties: VA disability
            and other
            VA-related claims. May also provide referrals to local Veteran
            Service Organizations
            for non-lawyer help with VA claims.</p>
        <h6>JAG and Military Legal Assistance Officers</h6>
        <p>Free legal help for active duty military, including activated Reserve
            and
            National Guard. Not specific to branch of service. Specialties:
            deployment-related
            issues.</p>
        <h6>State Bar Lawyer Referral Offices</h6>
        <p>Free information and referral to a local lawyer who handles your type
            of case.
        <p>Lawyers will charge for their services. Specialities: Wide range of
            legal matters;
            some specialize in VA issues.</p>
        <h6>Other</h6>
        <p>Includes law school clinics, locally-funded legal aid and pro bono
            projects.</p>
