...
jQuery.fn.cycle = function(options) {
    return this.each(function() {
        ...
        var opts = jQuery.extend({}, jQuery.fn.cycle.defaults, options || {}, jQuery.metadata ? $cont.metadata() : jQuery.meta ? $cont.data() : {});
        var meta = jQuery.isFunction($cont.data) ? $cont.data(opts.metaAttr) : null;
        if (meta)
